...
from inventario.views import Index, ViewInsumo, EntradaInsumo, SalidaInsumo, ViewCategoria, ViewUnidadMedida, \
    ...
    AddDetalleVentaModal, AddVenta, EditVenta, DeleteVenta, DeleteCompra, factura
...
urlpatterns = [
    ...
    path('salidas/delete/<int:pk>', DeleteCompra.as_view(), name="delete_compra"),
    ...
    path('salidas/delete/<int:pk>', DeleteVenta.as_view(), name="delete_venta"),
